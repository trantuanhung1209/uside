...
export default function Title(props : { title: string; desc: string, link?: string }) {
  ...
  return (
    <>
      ...
      >
        <h2 className="relative z-1 inline-block bg-background text-3xl font-bold text-text-primary px-[20px] hover:text-accent transition-all duration-300 xs:text-[26px] lg:scale-95 3xl:scale-100">
          {title}
        </h2>
