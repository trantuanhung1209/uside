...
const sliderStyles = `
  ...
  input[type="range"]::-webkit-slider-thumb {
    ...
    box-shadow: -2px -2px 4px #FAFBFF, 2px 2px 4px var(--color-shadow), 0 0 6px var(--color-text-secondary);
    border: none;
    cursor: pointer;
  }
...
const Television = () => {
  const { isPlaying, toggleMusic, volume, setVolume, playSpecificTrack } =
    useMusic();
  const [currentChannel, setCurrentChannel] = useState<TvChannel>(
    TV_CHANNELS[0]
  );
  ...
  return (
    <>
      ...
      <div className="relative z-1">
        <div
          className="rounded-[20px] p-3 transition-all duration-300 hover:scale-101 border-border"
          style={{
            backgroundColor: "var(--color-background)",
            boxShadow: `
    -10px -10px 10px color-mix(in srgb, #FAFBFF 60%, transparent),
     10px 10px 10px color-mix(in srgb, var(--color-accent) 10%, transparent)
  `,
          }}
        >
            ...
            <div className="w-full h-full rounded-[8px] relative overflow-hidden">
              ...
              <div className="relative z-10 w-full h-full rounded-[6px] overflow-hidden flex items-center justify-center">
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(45deg, transparent 30%, var(--color-accent)5 50%, transparent 70%)",
          ...
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              title={
                isPlaying
                  ? "Dừng phát (video + nhạc)"
                  : "Bắt đầu phát (video + nhạc)"
              }
              style={{
                backgroundColor: "var(--color-background)",
                borderRadius: "50%",
                ...
                <div className="relative w-full">
                  ...
                  <div
                    ...
                    style={{
                      ...
                      backgroundColor: "var(--color-secondary)",
                      boxShadow:
                        "inset -1px -1px 2px #FAFBFF, inset 1px 1px 2px rgba(22, 17, 29, 0.1)",
                    }}
                  />
                  ...
                  <div
                    ...
                    style={{
                      ...
                      backgroundColor: "var(--color-background)",
                      boxShadow:
                        "-2px -2px 4px #FAFBFF, 2px 2px 4px var(--color-shadow), 0 0 6px var(--color-text-secondary)30",
                    }}
                  />
                </div>
              </div>
        ...
        ></div>
        <div
          className="absolute bottom-[-15px] -left-10 w-12 h-12 rounded-full animate-pulse transition-all duration-300 hover:scale-110 z-10 xs:scale-50 lg:scale-100"
          style={{
            backgroundColor: "var(--color-secondary)",
            boxShadow:
        ...
        ></div>
        <div
          className="absolute bottom-[-15px] -right-8 w-8 h-8 rounded-full animate-pulse transition-all duration-300 hover:scale-110 xs:scale-0 lg:scale-100"
          style={{
            backgroundColor: "var(--color-secondary)",
            boxShadow:
