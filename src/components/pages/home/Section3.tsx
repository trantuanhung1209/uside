...
const Section3: React.FC = () => {
  ...
  return (
    <div className="relative">
      <div
        className="mt-8 xl:mt-12 bg-background rounded-4xl lg:rounded-2xl p-4 sm:p-6 md:p-8 mb-8 relative"
        style={{
          boxShadow:
      ...
      >
        ...
        >
          <div className="text-xs">
            Sử dụng mũi tên hoặc click vào các chấm để chuyển đổi nghề nghiệp
          </div>
